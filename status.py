...
def print_condition(condition, defending_mon_name):
    if condition == 'slp':
        print(defending_mon_name, 'fell asleep!')
    if condition == 'psn':
        print(defending_mon_name, 'was poisoned!')
    if condition == 'plz':
        print(defending_mon_name, 'was paralyzed! It may be unable to move!')
